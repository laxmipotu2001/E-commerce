              ...
              <div class="col-lg-12 grid-margin">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description">Order Details Here...
                    </p>
                    <div class="table-responsive" style="overflow-x: auto;">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php
                            $con=mysqli_connect("localhost","root","","task");
                            $sql1="select * from billing_detail";
                            ...
                            while($rw1=mysqli_fetch_row($rs1))
                            {
                              ...
                              echo "<td>$rw1[10]</td>";
                              echo "<td>$rw1[11]</td>";
                              echo "<td><a href='pupdate.php?id=$rw1[0]'>UPDATE</a></td>";
                              echo "<td><a href='pdelete.php?id=$rw1[0]'>Delete</a></td>";
                              echo "</tr>";
                            }
                          ?>
                        </tbody>
