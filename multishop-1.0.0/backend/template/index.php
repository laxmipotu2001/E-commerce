              ...
              <li class="nav-item nav-profile dropdown border-0">
                ...
                <div class="dropdown-menu navbar-dropdown w-100" aria-labelledby="profileDropdown">
                  ...
                  <a class="dropdown-item" href="adminlogout.php">
                    ...
                    $con=mysqli_connect("localhost","root","","task");
                    $email=$_SESSION['admin'];
                    $sql="select id from admin_reg where email='$email'";
                    $rs=mysqli_query($con,$sql);
                    $rw=mysqli_fetch_array($rs);
                    $admin=$rw['id']; 
                    ?>
                  <a class="dropdown-item" href="edit_admin.php?id=<?php echo $admin;?>">
                    <i class="mdi mdi-logout mr-2 text-primary"></i> Edit profile </a>
                </div>
              </li>
            </ul>
                  ...
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                    <div class="card bg-warning">
                      <div class="card-body px-3 py-4">
                        ...
                        <?php
                          $con=mysqli_connect("localhost","root","","task");
                          $sql="select count(cid) from category";
                          $rs=mysqli_query($con,$sql);
                          $rw=mysqli_fetch_array($rs);
                          $cat=$rw['count(cid)'];
                        ?>
                        <h1 class="text-white"><?php echo $cat;?> </h1>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                    <div class="card bg-danger">
                      <div class="card-body px-3 py-4">
                        ...
                        <?php
                          ...
                          $prod=$rw['count(id)'];
                        ?>
                        <h1 class="text-white"><?php echo $prod;?> </h1>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                    <div class="card bg-primary">
                      <div class="card-body px-3 py-4">
                        ...
                        <?php
                          ...
                          $ord=$rw['count(id)'];
                        ?>
                        <h1 class="text-white"><?php echo $ord;?></h1>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                    <div class="card bg-success">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <!-- <p class="mb-0 color-card-head">Categories</p> -->
                            <h2 class="text-white">Total Customers</h2>
                            <!-- <h2 class="text-white"> $8,753.<span class="h5">00</span> -->
                            </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-basket bg-inverse-icon-warning"></i>
                        ...
                        <?php
                          ...
                          $cust=$rw['count(id)'];
                        ?>
                        <h1 class="text-white"><?php echo $cust;?></h1>
                      </div>
                    </div>
                  </div>
                  <!-- <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
