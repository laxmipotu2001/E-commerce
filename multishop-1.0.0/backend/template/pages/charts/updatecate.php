  ...
  if($filename)
  	{
		  ...
		  {
		      $sql="update category set cname='$cname',img='$filename' where cid='$id'";
  	...
  	{
  		$sql="update category set cname='$cname' where cid='$id'";
  		if(mysqli_query($con,$sql))
  		{
  			header("location:chartjs.php");
  		}
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="exampleInputUsername1" name="uploadfile" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Category Name</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" value="<?php $rw[2];?>" name="cname" />
                      </div>
                      <?php
                    }
                    ?>
