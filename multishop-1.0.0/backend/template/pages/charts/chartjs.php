...
else
{
    if(isset($_POST['btn']))
    {
      ...
      {
          $sql="insert into category(cname,img) values('$cname','$filename')";
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card" style="height:340px;">
                  <div class="card-body">
                    ...
                    <p class="card-description">Add new categories here...</p>
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Category Image</label>
                        <input type="file" class="form-control" id="exampleInputUsername1" placeholder="Username" name="uploadfile" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputUsername1">Category Name</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Username" name="cname" />
                      </div>
                      <!-- <div class="form-group">
              ...
              <div class="col-lg-12 grid-margin">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> List of category of Eflayer... 
                    </p>
                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo "<img src='../images/$rw[2]' height='100px' width='100px'>"?></td>
                            <td><?php echo $rw[1];?></td>
                            <td><a href="updatecate.php?id=<?php echo $rw[0];?>">UPDATE</a></td>
                            <td><a href="deletecate.php?id=<?php echo $rw[0];?>">DELETE</a></td>
                            <?php
                          }
                          ?>
                          </tr>
