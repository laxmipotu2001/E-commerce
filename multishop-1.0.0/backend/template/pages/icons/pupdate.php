    ...
    if($imgname)
    {
      $filecount=count($_FILES['images']['name']);
        for($i=0; $i<$filecount;$i++)
        {
          ...
          array_push($newarr,$_FILES['images']['name'][$i]);
        }
        $path=implode(",", $newarr);
        $sql2="update product set img='$path',pname='$pname',price='$price',category='$cate',details='$description' where id='$id'";
    }

      $sql2="update product set pname='$pname',price='$price',category='$cate',details='$description' where id='$id'";
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Product Update Form</h3>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputUsername1">ADD Product Image</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $img;?>" name="pname" disabled />
                        <input type="file" class="form-control" id="exampleInputUsername1" placeholder="Images" name="images[]" multiple/>
                        <input type="hidden" name="old_img" value="<?php echo $img?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Product Name</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $pname;?>" name="pname" />
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="exampleInputPassword1" name="price" value="<?php echo $price?>" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Product Description</label>
                        <textarea type="number" class="form-control" id="exampleInputPassword1" name="description" value="<?php echo $descr?>"><?php echo $descr?></textarea>
                      </div>
                        ...
                        <tbody> -->
                          <!-- <?php
                            ...
                            while($rw=mysqli_fetch_row($rs))
                            {
                              ...
                              for ($i=0;$i<$count;$i++)
                              {
                                  echo "<td><img src='../images/$sizemulti[$i]'></td>";
                              }
                              echo "<td>$rw[2]</td>";
                              echo "<td>$rw[3]</td>";
                              echo "<td>$rw[4]</td>";
