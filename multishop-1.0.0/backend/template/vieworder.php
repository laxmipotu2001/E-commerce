    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
            ...
            <!-- <div class="row"> -->
              <!-- <div class="col-lg-12 grid-margin"> -->
                <?php
                    ...
                    // 
                    $sql1="select * from billing_detail where cust_id='$cid'";
        ...
        <div class="brand-section">
            <div class="row">
                <div class="col-6">
                    ...
                    <img src="./assets/images/logo.png" class="text-white" height="150px" width="150px">
                </div>
                <div class="col-6">
                    <div class="company-details">
                        <!-- <p class="text-white">assdad asd  asda asdad a sd</p> -->
                        <p class="text-white">Customer Services</p>
                        <p class="text-white">+012 345 6789</p><br><br>
        ...
        <div class="body-section">
            <div class="row">
                <div class="col-6">
                    <h2 class="heading">Invoice No:- <?php echo $random;?></h2>
                ...
                <div class="col-6">
                    <p class="sub-heading">Full Name:  <?php echo $fname.' '.$lname;?>  </p>
                    <p class="sub-heading">Address:  <?php echo $address;?> </p>
                    <p class="sub-heading">Phone Number:  <?php echo $mobile;?> </p>
                    <p class="sub-heading">City,State,Pincode:   <?php echo $city.' '.$state.' '.$zip;?> </p>
                </div>
            </div>
        </div>
        ...
        <div class="body-section">
            ...
            <table class="table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="w-20"><center>Price</center></th>
                        <th class="w-20"><center>Quantity</center></th>
            ...
            <h3 class="heading">Payment Mode:  <?php echo $payment;?></h3>
        </div>   
    </div>      
           ...
           <!--  </div> -->
              ...
              <!-- <div class="col-xl-3 col-lg-12 stretch-card grid-margin">
                <div  style="display: inline-flex; height: 200px; width: 280px;">
                      ...
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card"> -->
                            ...
                            <!-- <h2 class="text-white">Total Categories</h2> -->
                    ...
                    <div class="card bg-danger">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card"> -->
                            <!-- <p class="mb-0 color-card-head">Categories</p> -->
                            <!-- <h2 class="text-white">Total Products</h2> -->
                            <!-- <h2 class="text-white"> $8,753.<span class="h5">00</span> -->
                           <!--  </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-basket bg-inverse-icon-warning"></i>
